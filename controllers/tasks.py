...
from core.dependencies import get_current_active_user, PaginationParams
...
# Delegate advanced skill/assignment/assessment routes to the modular engine router
from services.tasks.api import router as modular_tasks_router
for _route in modular_tasks_router.routes:
