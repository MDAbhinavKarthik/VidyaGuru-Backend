...
from core.dependencies import get_redis, get_current_user
from services.tasks.models import TaskType, TaskStatus, TaskDifficulty, SkillCategory
...
from services.tasks.service import TaskService, SkillService, TaskAnalyticsService
