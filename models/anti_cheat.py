"""
Anti-Cheat System Database Models
==================================

Models for tracking submissions and detecting suspicious behavior:
- SubmissionAnalysis: Analyzes each submission for plagiarism/typing patterns
- VerificationChallenge: Issues verification tasks when cheating suspected
- UserIntegrityProfile: Tracks user's overall trust/integrity metrics
- SuspiciousActivityLog: Logs all detected suspicious activities
- SubmissionFingerprint: Stores fingerprints for similarity detection
"""
